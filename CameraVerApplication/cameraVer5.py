...
class ObjectDetection:
    def __init__(self):
        ...
        self.conf_threshold = 0.6  # Порог уверенности для детекции
        ...
        self.sound_cooldown = 2  # Время ожидания между воспроизведением звуков (в секундах)
    ...
    def save_image(self, frame, class_name):
       ...
       # Отправка изображения в Telegram
        ...
        # не работает с этим вариантом Отправка изображения в Telegram без запуска нового цикла событий
        # loop = asyncio.get_event_loop()
        # loop.create_task(self.send_photo_to_telegram(image_path))
